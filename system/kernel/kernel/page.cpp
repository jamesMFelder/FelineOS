...
largePage::largePage(void const *const virt_addr) : page(virt_addr) {}

largePage::largePage(uintptr_t const virt_addr) : page(virt_addr) {}
...
/* Return the address */
void *page::get() const { return reinterpret_cast<void *>(addr); }

/* Return the address as a uintptr_t (not encouraged) */
uintptr_t page::getInt() const { return addr; }
...
page::operator void *() const { return reinterpret_cast<void *>(addr); }

/* Check if it is null */
bool page::isNull() const { return addr == 0; }
